 ...
 * [cheminf.yml](cheminf.yml)
     * Determines how your purl.obolibrary.org/obo/cheminf/ redirects will be handled
     ...
     * Paste in the contents of [cheminf.yml](cheminf.yml)
 ...
 * [cheminf.md](cheminf.md)
     ...
     * Paste in the contents of [cheminf.md](cheminf.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
