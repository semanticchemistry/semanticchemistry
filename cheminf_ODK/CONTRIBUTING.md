# Contributing to chemical information ontology (cheminf) - information entities about chemical entities

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to CHEMINF. 
...
Please use our [Issue Tracker](https://github.com/semanticchemistry/semanticchemistry/issues/) for reporting problems with the ontology. 
...
either as a primary term or a synonym term. You can search for your term using [OLS](http://www.ebi.ac.uk/ols/ontologies/cheminf).
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/semanticchemistry/semanticchemistry/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/semanticchemistry/semanticchemistry/issues/new/choose).
...
1. Open src/ontology/cheminf-edit.owl in your favourite editor, i.e. [Protege](https://protege.stanford.edu/). **Careful:** double check you are editing the correct file. There are many ontology files in this repository, but only one _editors file_!
