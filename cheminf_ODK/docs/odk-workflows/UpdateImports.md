...
To enable this workflow, you add the following to your ODK config file (`src/ontology/cheminf-odk.yaml`), and [update the repository](RepoManagement.md):
...
To check if your ontology uses this method, check src/ontology/cheminf-odk.yaml to see if `use_base_merging: TRUE` is declared under `import_group`
