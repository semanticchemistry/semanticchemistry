...
The documentation for CHEMINF is managed in two places (relative to the repository root):
...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://semanticchemistry.github.io/semanticchemistry/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://semanticchemistry.github.io/semanticchemistry/). 
